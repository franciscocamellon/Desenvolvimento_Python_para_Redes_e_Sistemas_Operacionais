...
class Questao_01():
    ...
    def process_data(self):
        ...
        for i in psutil.process_iter():
            if psutil.pid_exists(i.pid):
                self.info_dict[i.pid] = [i.name(),i.cpu_percent(),round(i.memory_percent(),2)]
            else:
                pass
    ...
    def print_result(self):
        ...
        print('{}{:<7}{:<10}{:<10}{:<10}'.format(' '*2, 'PID', 'CPU %', 'MEM %', 'Nome'),'---' * 25, sep='\n')
        for pid, info_pid in self.info_dict.items():
            print('{}{:<7}{:<10}{:<10}{:<10}'.format(' '*2, pid, info_pid[1], info_pid[2], info_pid[0]))
            time.sleep(0.1)
